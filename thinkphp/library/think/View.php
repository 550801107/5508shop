...
class View
{
    ...
    public function __construct($engine = [], $replace = [])
    {
        ...
        //获取配置
        $ItkeeThemePath    = TMPL_THEMES_NAME;
        $ItkeeDefaultTheme = ItkeeGetTheme(); //获取主题名字
        $HomeThemePath = "{$ItkeeThemePath}HomeThemes/{$ItkeeDefaultTheme}";
        $AdminThemePath = "{$ItkeeThemePath}AdminThemes";
        $baseReplace = [
            '__ROOT__'           => $root,
            ...
            '__BT__'             => $root . '/static/bootstrap',
            '__ADMIN_TMPL__'     => "{$root}/{$AdminThemePath}/resources",
            '__HOME_TMPL__'      => "{$root}/{$HomeThemePath}/resources",
        ];
